...
const es = {
  ...
  handicapCommittee: {
    ...
    voter: {
      ...
      thVotes: "Votos",
      thVotesTitle: "Votos emitidos (incluye abstenciones)",
      thLive: "Vivos",
      thLiveTitle: "Vivos / total contando abstenciones como 0",
      thAvg: "Prom",
      ...
      legendVotes: "emitidos en total",
      legendLive: "que cuentan al promedio (incluye abst. como 0)",
      ...
      chipAbstainTitle: "Abstención (cuenta como 0 en el promedio)",
    ...
    card: {
      ...
      summaryLiveLong: "núm. vivos",
      summaryNumShort: "núm.; prom. ÷",
      summaryAbstSuffix: "abst. como 0",
    },
    admin: {
...
const en: Messages = {
  ...
  handicapCommittee: {
    ...
    voter: {
      ...
      thVotes: "Votes",
      thVotesTitle: "Votes cast (includes abstentions)",
      thLive: "Live",
      thLiveTitle: "Live / total counting abstentions as 0",
      thAvg: "Avg",
      ...
      legendVotes: "total cast",
      legendLive: "count towards the average (abstentions as 0)",
      ...
      chipAbstainTitle: "Abstention (counts as 0 in the average)",
    ...
    card: {
      ...
      summaryLiveLong: "live num.",
      summaryNumShort: "num.; avg ÷",
      summaryAbstSuffix: "abst. as 0",
    },
    admin: {
