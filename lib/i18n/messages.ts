...
const es = {
  ...
  handicapCommittee: {
    ...
    admin: {
      ...
      membersTitle: "Miembros del comité (marcar presentes)",
      membersHelp:
        "Autoriza quién puede votar en este torneo y marca su asistencia. El alcance define si el acceso es solo aquí, en todo el club o en todo el sistema.",
      addMember: "Agregar miembro existente",
      ...
      addCommitteeHint:
        "El usuario quedará con permiso «Comité de Handicap». Después marca su asistencia con el botón verde de su tarjeta para habilitar su voto.",
...
const en: Messages = {
  ...
  handicapCommittee: {
    ...
    admin: {
      ...
      membersTitle: "Committee members (mark attendance)",
      membersHelp:
        "Authorize who can vote in this tournament and mark their attendance. Scope defines whether access is only here, the whole club or the whole system.",
      addMember: "Add existing member",
      ...
      addCommitteeHint:
        "The user will get the «Handicap Committee» permission. Then mark their attendance with the green button on their card to enable their vote.",
