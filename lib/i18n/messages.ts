...
const es = {
  ...
  handicapCommittee: {
    ...
    voter: {
      ...
      progressVotePrivate: "Voto privado. Solo bajar HI (−0.5 a −5.0).",
      tabPending: "Pendientes",
      tabRated: "Calificados",
      tabResults: "Resultados",
      searchPlaceholder: "Buscar jugador, club, HI…",
    ...
    admin: {
      ...
      bulkBarHint:
        "Los ajustes son golpes directos al handicap de torneo (HP). El índice no se modifica. Sin votos el ajuste inicia en 0 y puedes editarlo antes de aplicar.",
...
const en: Messages = {
  ...
  handicapCommittee: {
    ...
    voter: {
      ...
      progressVotePrivate: "Private vote. Lower HI only (−0.5 to −5.0).",
      tabPending: "Pending",
      tabRated: "Rated",
      tabResults: "Results",
      searchPlaceholder: "Search player, club, HI…",
    ...
    admin: {
      ...
      bulkBarHint:
        "Adjustments are strokes applied directly to tournament handicap (HP). The index is not changed. With no votes the adjustment starts at 0 and you can edit it before applying.",
