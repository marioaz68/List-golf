...
const es = {
  ...
  handicapCommittee: {
    ...
    pageSubtitle: "Voto anónimo · Solo bajar HI (−0.5 a −5.0)",
    ...
    bannerHiApplied: "HI del torneo actualizado con el ajuste sugerido.",
    bannerHiAppliedBulk: "HI del torneo actualizado para {n} jugador(es).",
    bannerHiAppliedBulkPartial:
      "HI del torneo actualizado para {ok} jugador(es). {fail} falló(s).",
    ...
    voter: {
      ...
      thPlayer: "Jugador",
      thHi: "HI",
      thHiTitle: "Handicap Index actual del torneo",
      thVotes: "Votos",
      ...
      thAvg: "Prom",
      thAvgTitle: "Promedio recortado del ajuste",
      thHiSug: "HI sug",
      thHiSugTitle: "HI sugerido = HI actual + Promedio",
      thVetos: "Vetos",
      thVetosTitle: "Votos de «No permitir jugar este torneo»",
      legendHi: "Handicap Index actual",
      ...
      expandedHi: "HI actual",
      expandedAvg: "Prom.",
      expandedHiSug: "HI sug.",
    ...
    card: {
      ...
      summaryHiCurrent: "HI actual",
      summaryAvg: "Promedio",
      summaryHiSug: "HI sugerido",
    ...
    admin: {
      ...
      thHiSug: "HI sugerido",
      thNoPlay: "No jugar",
      thRoundedAdj: "Redondeo",
      thRoundedAdjTitle: "Ajuste manual redondeado (paso 0.1)",
      thFinalHi: "HI definitivo",
      thFinalHiTitle: "HI que se aplicará al torneo (HI actual + Redondeo)",
      applyHi: "Aplicar HI",
...
const en: Messages = {
  ...
  handicapCommittee: {
    ...
    pageSubtitle: "Anonymous vote · Lower HI only (−0.5 to −5.0)",
    ...
    bannerHiApplied: "Tournament HI updated with the suggested adjustment.",
    bannerHiAppliedBulk: "Tournament HI updated for {n} player(s).",
    bannerHiAppliedBulkPartial:
      "Tournament HI updated for {ok} player(s). {fail} failed.",
    ...
    voter: {
      ...
      thPlayer: "Player",
      thHi: "HI",
      thHiTitle: "Current tournament Handicap Index",
      thVotes: "Votes",
      ...
      thAvg: "Avg",
      thAvgTitle: "Trimmed average of the adjustment",
      thHiSug: "Sug HI",
      thHiSugTitle: "Suggested HI = current HI + Average",
      thVetos: "Vetoes",
      thVetosTitle: "Votes of «Do not allow to play this tournament»",
      legendHi: "Current Handicap Index",
    ...
    card: {
      ...
      summaryHiCurrent: "Current HI",
      summaryAvg: "Average",
      summaryHiSug: "Suggested HI",
      summaryLiveLong: "adj.",
      summaryNumShort: "num.",
      summaryAbstSuffix: "abst.",
    },
    admin: {
      ...
      thRoundedAdj: "Rounded",
      thRoundedAdjTitle: "Manual rounded adjustment (step 0.1)",
      thFinalHi: "Final HI",
      thFinalHiTitle: "HI that will be applied to the tournament (current HI + Rounded)",
      applyHi: "Apply HI",
